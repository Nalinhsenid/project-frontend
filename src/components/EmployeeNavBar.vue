    ...
    <b-row class="justify-content-center mt-3">
      <b-col col lg="2">
        ...
        <router-link to="/leavehistory" class="text-decoration-none">
          <b-button pill variant="outline-primary">Leave Timeline
          </b-button>
        </router-link>
      </b-col>
      <b-col col lg="2">
        <router-link to="/leavebalance" class="text-decoration-none">
          <b-button pill variant="outline-primary" >Leave Balance</b-button>
        </router-link>
      </b-col>
      <b-col col lg="2">

        <router-link to="/addleave" class="text-decoration-none">
          <b-button pill variant="outline-primary" >Request a Leave</b-button>
        </router-link>
      </b-col>
    </b-row>
  </b-container>
